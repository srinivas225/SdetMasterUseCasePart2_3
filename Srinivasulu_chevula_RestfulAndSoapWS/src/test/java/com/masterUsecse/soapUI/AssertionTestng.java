...
public class AssertionTestng {
    ...
    public void testHttpGet() {
        ...
        try {
            ...
            assertEquals(statusCode, 200, "Expected response code: 200, Actual response code: " + statusCode);
    ...
    public class HttpPostTest {
        ...
        private void performHttpPostAndAssert() {
            ...
            try {
                ...
                assertEquals(statusCode, Integer.parseInt(expectedResponse), "Expected response code: " + expectedResponse + ", Actual response code: " + statusCode);

                // Close the HttpClient when done.
                httpClient.close();
            } catch (Exception e) {
                e.printStackTrace();
                AssertJUnit.fail("POST request failed");
            }
        }
    }
