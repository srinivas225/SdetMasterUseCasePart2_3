...
public class AssertionTestng {
    ...
    public void testHttpGet() {
        ...
        try {
            ...
            Assert.assertEquals(statusCode, 200, "Expected response code: 200, Actual response code: " + statusCode);
    ...
    public class HttpPostTest {
        ...
        private void performHttpPostAndAssert() {
            ...
            try {
                ...
                Assert.assertEquals(statusCode, Integer.parseInt(expectedResponse), "Expected response code: " + expectedResponse + ", Actual response code: " + statusCode);
